...
let
  catppuccinMochaCss = ''
    ...
    @define-color headerbar_border_color rgba(0.191406, 0.195312, 0.265625, 0.7);
    ...
    @define-color scrollbar_outline_color #45475a;
...
in
{
  gtk = {
    ...
    gtk3.extraCss = catppuccinMochaCss;
    gtk4.extraCss = catppuccinMochaCss;
  };
}
